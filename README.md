...
* У режимі P - примусово вмикається 1 передачі і модель не реагує на положення курка
* У режимі N - примусово вмикається лише нейтралка і модель реагує на положення курка. Можна газувати на місці.
* У режимі N - перехіду у режим D чи P відбувається тільки при повній зупинці мотора.
