...
void SetupController::loadConfig()
{
	...
	this->cfg->fire_sound = cfg.getInt("fire_sound");
...
void SetupController::printConfig(JsonString* out)
{
	...
	out->AddValue("fire_sound", String(cfg->fire_sound));
...
void SetupController::Setup_Post()
{
	...
	if (webServer.hasArg("fire_sound")) { setupController.cfg->fire_sound = webServer.arg("fire_sound").toInt(); }
